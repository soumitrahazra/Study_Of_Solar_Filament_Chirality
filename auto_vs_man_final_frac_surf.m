...
for i=1:length(jds)-1
    for k=1:length(binedges)-1
        ...
        if(pos~=0)
            ...
            if ((dexstr1(i,k)+ sinstr1(i,k))~=0)
            frac_chir1(i,k)= strength1(i,k)/(dexstr1(i,k)+ sinstr1(i,k));
            else
            frac_chir1(i,k)= 0;
          end
        if ((dexstr1t(i,k)+ sinstr1t(i,k))~=0)
            frac_chir1t(i,k)= strength1t(i,k)/(dexstr1t(i,k)+ sinstr1t(i,k));
            else
            frac_chir1t(i,k)= 0;
          end
        if ((dexstr2(i,k)+ sinstr2(i,k))~=0)
            frac_chir2(i,k)= strength2(i,k)/(dexstr2(i,k)+ sinstr2(i,k));
            else
            frac_chir2(i,k)= 0;
          end
        if ((dexstr2t(i,k)+ sinstr2t(i,k))~=0)
            frac_chir2t(i,k)= strength2t(i,k)/(dexstr2t(i,k)+ sinstr2t(i,k));
            else
            frac_chir2t(i,k)= 0;
          end
...
hold on
subplot(4,1,1)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, frac_chir1); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, frac_chir1'); shading flat
...
colorbar;
subplot(4,1,2)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, frac_chir2); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, frac_chir2'); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
title('(b)')
subplot(4,1,3)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, frac_chir1t); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, frac_chir1t'); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,1,4)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, frac_chir2t); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, frac_chir2t'); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
[cmap]=cbrewer('div','PRGn',200);
colormap(cmap);
colorbar;
title('(d)')
view(90,270)
