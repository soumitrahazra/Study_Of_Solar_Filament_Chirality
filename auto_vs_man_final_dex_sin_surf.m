...
hold on
subplot(4,2,1)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, dexstr1./max(max(abs(dexstr1)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, dexstr1'./max(max(abs(dexstr1)))); shading flat
...
%view(90,270)
subplot(4,2,2)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, -sinstr1./max(max(abs(sinstr1)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, - sinstr1'./max(max(abs(sinstr1)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
title('(e)')
subplot(4,2,3)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, dexstr2./max(max(abs(dexstr2)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, dexstr2'./max(max(abs(dexstr2)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
%view(90,270)
subplot(4,2,4)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, -sinstr2./max(max(abs(sinstr2)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, - sinstr2'./max(max(abs(sinstr2)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
title('(f)')
subplot(4,2,5)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, dexstr1t./max(max(abs(dexstr1t)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, dexstr1t'./max(max(abs(dexstr1t)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
%view(90,270)
subplot(4,2,6)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, -sinstr1t./max(max(abs(sinstr1t)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, - sinstr1t'./max(max(abs(sinstr1t)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
title('(g)')
subplot(4,2,7)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, dexstr2t./max(max(abs(dexstr2t)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, dexstr2t'./max(max(abs(dexstr2t)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
%view(90,270)
subplot(4,2,8)
surf((binedges(1:end-1)+100)*(90)/918, (jds(1:end-1)-jds(1))/365.24+2000+8/12, -sinstr2t./max(max(abs(sinstr2t)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, - sinstr2t'./max(max(abs(sinstr2t)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
