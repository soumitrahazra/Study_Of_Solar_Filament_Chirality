...
for i=1:length(jds)-1
    for k=1:length(binedges)-1
        ...
        if(pos~=0)
            ...
            chirality1t(i,k)=sum(chir1t_yr(i,pos));
            chirality2t(i,k)=sum(chir2t_yr(i,pos));
...
hold on
subplot(4,2,1)
%cotourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, determ_auto'./max(max(abs(determ_auto)))); shading flat
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, determ_auto./max(max(abs(determ_auto)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
[cmap]=cbrewer('div','PRGn',100);
colormap(cmap);
colorbar;
text(-0.25,0.90,'$textcircled{bf a}$', 'Interpreter', 'latex');
title('(a)')
%caxis([-1 1])
view(90,270)
subplot(4,2,2)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, undeterm_auto./max(max(abs(undeterm_auto)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, undeterm_auto'./max(max(abs(undeterm_auto)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,3)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, determ_manu./max(max(abs(determ_manu)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, determ_manu'./max(max(abs(determ_manu)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,4)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, undeterm_manu./max(max(abs(undeterm_manu)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, undeterm_manu'./max(max(abs(undeterm_manu)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,5)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, determ_autot./max(max(abs(determ_autot)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, determ_autot'./max(max(abs(determ_autot)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,6)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, undeterm_autot./max(max(abs(undeterm_autot)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, undeterm_autot'./max(max(abs(undeterm_autot)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,7)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, determ_manut./max(max(abs(determ_manut)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*(90)/918, determ_manut'./max(max(abs(determ_manut)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
...
view(90,270)
subplot(4,2,8)
surf((binedges(1:end-1)+100)*(90)/918,  (jds(1:end-1)-jds(1))/365.24+2000+8/12, undeterm_manut./max(max(abs(undeterm_manut)))); shading flat
%contourf((jds(1:end-1)-jds(1))/365.24+2000+8/12, (binedges(1:end-1)+100)*90/918, undeterm_manut'./max(max(abs(undeterm_manut)))); shading flat
xlabel('Latitude (deg)','FontSize',14)
ylabel('Time (years)','FontSize',14)
xlim([-70 70])
ylim([2000.6 2016.8])
